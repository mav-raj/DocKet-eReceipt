...
public class viewGrocery extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.grocery_layout, container, false);
        ...
        mRef = mRef.child(user).child("Bills").child("Grocery");
        mReceipt = (RecyclerView) rootView.findViewById(R.id.groceryRecycler);
