...
public class viewMedical extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.medical_layout, container, false);
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Users").child(user).child("Bills").child("Medical");
        mReceipt = (RecyclerView) rootView.findViewById(R.id.medicalRecycler);
