...
public class viewHardware extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.hardware_layout, container, false);
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Users").child(user).child("Bills").child("Hardware");
        mReceipt = (RecyclerView) rootView.findViewById(R.id.hardwareRecycler);
