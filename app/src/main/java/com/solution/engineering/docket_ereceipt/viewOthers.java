...
public class viewOthers extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Users").child(user).child("Bills").child("Others");
        mReceipt = (RecyclerView) rootView.findViewById(R.id.othersRecycler);
